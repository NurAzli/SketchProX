...
public class ImageFactory {
     ...
     * @param imageName The image's name inside /Internal storage/SketchProX/saved_block/.
     * @return A File object of the saved bitmap.
     */
    public static File saveBitmap(View view, String imageName) {
        File saveToDirectory = new File(FileUtil.getExternalStorageDir(), "SketchProX/saved_block");
