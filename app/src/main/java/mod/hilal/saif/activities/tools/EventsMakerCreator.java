...
import com.SketchProX.remod.databinding.EventsCreatorBinding;
...
public class EventsMakerCreator extends Activity {
    ...
    private void save() {
        if (!filledIn()) {
            SketchProXUtil.toast("Some required fields are empty!");
            return;
        }
        ...
        String concat = FileUtil.getExternalStorageDir().concat("/.SketchProX/data/system/events.json");
