...
import com.SketchProX.remod.databinding.AddCustomAttributeBinding;
import com.SketchProX.remod.databinding.AddNewListenerBinding;
...
public class EventsMaker extends Activity {
    ...
    private void showAddDial() {
        ...
        listenerBinding.save.setOnClickListener(v -> {
            ...
            SketchProXUtil.toastError("Invalid name!");
        });
        ...
        filePickerDialog.setDialogSelectionListener(selections -> {
            if (FileUtil.readFile(selections[0]).equals("")) {
                ...
                try {
                    ...
                    SketchProXUtil.toastError("Invalid file");
                }
            }
        });
    ...
    private void importEvents(ArrayList<HashMap<String, Object>> data, ArrayList<HashMap<String, Object>> data2) {
        ...
        FileUtil.writeFile(LISTENERS_FILE.getAbsolutePath(), new Gson().toJson(listMap));
        refreshList();
        SketchProXUtil.toast("Successfully imported events");
    }
    ...
    private void exportAll() {
        ...
        SketchProXUtil.toast("Successfully exported events to:\n" +
                "/Internal storage/.SketchProX/data/system/export/events", Toast.LENGTH_LONG);
    }

    private void export(int p) {
        String concat = FileUtil.getExternalStorageDir().concat("/.SketchProX/data/system/export/events/");
        ...
        SketchProXUtil.toast("Successfully exported event to:\n" +
                "/Internal storage/.SketchProX/data/system/export/events", Toast.LENGTH_LONG);
    }
    ...
    private CardView newCard(int width, int height, float weight) {
        ...
        layoutParams.setMargins(
                ...
                (int) SketchProXUtil.getDip(6),
                (int) SketchProXUtil.getDip(4),
                (int) SketchProXUtil.getDip(2)
        );
        ...
        cardView.setRadius(SketchProXUtil.getDip(4));
        return cardView;
    }
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            a(linearLayout, (int) SketchProXUtil.getDip(4), (int) SketchProXUtil.getDip(2), true);
