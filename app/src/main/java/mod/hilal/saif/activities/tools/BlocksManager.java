...
public class BlocksManager extends AppCompatActivity {
    ...
    private void _readSettings() {
        ...
        if (FileUtil.isExistFile(blocks_dir)) {
            ...
            SketchProXUtil.showFailedToParseJsonDialog(this, new File(blocks_dir), "Custom Blocks", v -> _readSettings());
        }
    }
    ...
    private void _refresh_list() {
        parsePaletteJson:
        {
            ...
            if (FileUtil.isExistFile(pallet_dir) && !(paletteJsonContent = FileUtil.readFile(pallet_dir)).equals("")) {
                ...
                SketchProXUtil.showFailedToParseJsonDialog(this, new File(pallet_dir), "Custom Block Palettes", v -> _refresh_list());
            }
    ...
    public class PaletteAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                SketchProXUtil.toastError("Invalid background color '" + paletteColorValue + "' in Palette #" + (position + 1));
