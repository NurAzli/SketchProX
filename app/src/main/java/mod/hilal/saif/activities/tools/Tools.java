...
public class Tools extends Activity {
    ...
    private void setupViews() {
        ...
        makeup(openWorkingDirectoryLayout, R.mipmap.ic_type_folder, "Open working directory", "Open SketchProX's directory and edit files in it");
    ...
    private void signApkFileDialog() {
        ...
        apkPathDialog.b("Next", next -> {
            ...
            String output_apk_path = new File(Environment.getExternalStorageDirectory(),
                    "SketchProX/signed_apk/" + output_apk_file_name).getAbsolutePath();
            ...
            if (new File(output_apk_path).exists()) {
                ...
                confirmOverwrite.a("An APK named " + output_apk_file_name + " already exists at " +
                        "/Internal storage/SketchProX/signed_apk/. Overwrite it?");
            ...
            public void run() {
                ...
                runOnUiThread(() -> {
                    if (callback.errorCount.get() == 0) {
                        ...
                        SketchProXUtil.toast("Successfully saved signed APK to: /Internal storage/SketchProX/signed_apk/"
