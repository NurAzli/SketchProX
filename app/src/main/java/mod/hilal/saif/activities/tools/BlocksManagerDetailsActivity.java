...
public class BlocksManagerDetailsActivity extends AppCompatActivity {
    ...
    private static final String BLOCK_EXPORT_PATH = new File(FileUtil.getExternalStorageDir(), ".SketchProX/resources/block/export/").getAbsolutePath();
    ...
    private void initialize() {
                ...
                switch (item.getTitle().toString()) {
                    ...
                    case "Export blocks":
                        ...
                        if (paletteName instanceof String) {
                            ...
                            SketchProXUtil.toast("Successfully exported blocks to:\n" + exportTo, Toast.LENGTH_LONG);
                        } else {
                            SketchProXUtil.toastError("Invalid name of palette #" + (palette - 9));
                        }
                        break;
        ...
        _fab.setOnClickListener(v -> {
            ...
            if (paletteColor instanceof String) {
                ...
                SketchProXUtil.toastError("Invalid color of palette #" + (palette - 9));
            }
        });
    }
    ...
    private void _refreshLists() {
        ...
        parseLists:
        {
            ...
            SketchProXUtil.showFailedToParseJsonDialog(this, new File(pallet_path), "Custom Block Palettes", v -> _refreshLists());
        ...
        parseBlocks:
        {
            ...
            SketchProXUtil.showFailedToParseJsonDialog(this, new File(blocks_path), "Custom Blocks", v -> _refreshLists());
        ...
        for (int i = 0; i < all_blocks_list.size(); i++) {
            ...
            if (blockPalette instanceof String) {
                try {
                    ...
                    SketchProXUtil.toastError("Invalid palette entry in block #" + (i + 1));
                }
            }
        }
    ...
    private void _duplicateBlock(int position) {
        ...
        if (blockName instanceof String) {
            if (((String) blockName).matches("(?s).*_copy[0-9][0-9]")) {
                block.put("name", ((String) blockName).replaceAll("_copy[0-9][0-9]", "_copy" + SketchProXUtil.getRandom(11, 99)));
            } else {
                block.put("name", blockName + "_copy" + SketchProXUtil.getRandom(11, 99));
            }
        }
    ...
    private void _changePallette(final int position) {
        ...
        for (int j = 0, pallet_listSize = pallet_list.size(); j < pallet_listSize; j++) {
            ...
            if (name instanceof String) {
                ...
                SketchProXUtil.toastError("Invalid name of Custom Block palette #" + (j + 1));
            }
        }
        ...
        try {
            ...
            for (int i = 0; i < blocks.size(); i++) {
                ...
                if (blockName instanceof String) {
                    ...
                    SketchProXUtil.toastError("Invalid name entry of Custom Block #" + (i + 1) + " in Blocks to import");
                }
            }
            ...
            import_dialog.setTitle("Import blocks")
                    ...
                    .setPositiveButton("Import", (dialog, which) -> {
                        ...
                        FileUtil.writeFile(blocks_path, new Gson().toJson(all_blocks_list));
                        _refreshLists();
                        SketchProXUtil.toast("Imported successfully");
                    })
            ...
            SketchProXUtil.toastError("An error occurred! [" + e.getMessage() + "]");
        }
    }
                ...
                if (block.containsKey("color")) {
                    ...
                    if (blockColor instanceof String) {
                        ...
                        try {
                            ...
                            SketchProXUtil.toastError("Invalid color entry in block #" + (position + 1));
                        }
                    ...
                    if (paletteColor instanceof String) {
                        try {
                            ...
                            SketchProXUtil.toastError("Invalid color in Custom Block palette #" + (palette - 8));
                        }
                    }
                }
            }
