...
import a.a.a.Lx;
import a.a.a.xB;
import mod.SketchProXUtil;
import mod.agus.jcoderz.lib.FileUtil;
import mod.hey.studios.util.Helper;
import mod.jbk.util.OldResourceIdMapper;
//responsible code :
//ComponentBean == SketchProX / beans √
...
public class ComponentsHandler {
        ...
        for (int i = 0; i < cachedCustomComponents.size(); i++) {
            ...
            if (component != null) {
                ...
                if (typeName instanceof String) {
                    if (name.equals(typeName)) {
                        ...
                        if (id instanceof String) {
                            try {
                                ...
                                SketchProXUtil.toastError("Invalid ID entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        } else {
                            SketchProXUtil.toastError("Invalid ID entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                    ...
                    SketchProXUtil.toastError("Invalid type name entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
            } else {
                SketchProXUtil.toastError("Invalid (null) Custom Component at position " + i);
            }
        }
                    ...
                    try {
                        ...
                        if (idInt == id) {
                            ...
                            if (componentTypeName instanceof String) {
                                ...
                                SketchProXUtil.toastError("Invalid type name entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        }
                    } catch (NumberFormatException e) {
                        SketchProXUtil.toastError("Invalid ID entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                    }
                } else {
                    SketchProXUtil.toastError("Invalid ID entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
                    ...
                    try {
                        ...
                        if (idInt == id) {
                            ...
                            if (componentName instanceof String) {
                                ...
                                SketchProXUtil.toastError("Invalid name entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        }
                    } catch (NumberFormatException e) {
                        SketchProXUtil.toastError("Invalid ID entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                    }
                } else {
                    SketchProXUtil.toastError("Invalid ID entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
                        ...
                        if (componentId == id) {
                            ...
                            if (iconObject instanceof String) {
                                try {
                                    ...
                                    SketchProXUtil.toastError("Invalid icon entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                    break;
                                }
                            }
                        }
                    ...
                    try {
                        ...
                        if (idInt == id) {
                            ...
                            if (componentDescription instanceof String) {
                                ...
                                SketchProXUtil.toastError("Invalid description entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        }
                    } catch (NumberFormatException e) {
                        ...
                        try {
                            ...
                            if (componentIdInteger == id) {
                                ...
                                if (componentUrl instanceof String) {
                                    ...
                                    SketchProXUtil.toastError("Invalid URL entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                    break;
                                }
                            }
                        } catch (NumberFormatException e) {
                    ...
                    try {
                        ...
                        if (componentIdInteger == id) {
                            ...
                            if (componentBuildClass instanceof String) {
                                ...
                                SketchProXUtil.toastError("Invalid build class entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        }
                    } catch (NumberFormatException e) {
                    ...
                    try {
                        ...
                        if (componentIdInteger == id) {
                            ...
                            if (componentVarName instanceof String) {
                                ...
                                SketchProXUtil.toastError("Invalid variable name entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                                break;
                            }
                        }
                    } catch (NumberFormatException e) {
                ...
                if (componentTypeName instanceof String) {
                    if (name.equals(componentTypeName)) {
                        ...
                        if (componentClass instanceof String) {
                            ...
                            SketchProXUtil.toastError("Invalid class entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                            break;
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Invalid type name entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
            } else {
                SketchProXUtil.toastError("Invalid (null) Custom Component at position " + i);
            }
                ...
                if (componentName instanceof String) {
                    if (name.equals(componentName)) {
                        ...
                        if (componentAdditionalVar instanceof String) {
                            ...
                            SketchProXUtil.toastError("Invalid additional variable entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Invalid name entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
            } else {
                SketchProXUtil.toastError("Invalid (null) Custom Component at position " + i);
            }
                ...
                if (componentName instanceof String) {
                    if (name.equals(componentName)) {
                        ...
                        if (componentDefineAdditionalVar instanceof String) {
                            ...
                            SketchProXUtil.toastError("Invalid additional variable entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Invalid name entry in Custom Component #" + (i + 1));
                }
            } else {
                SketchProXUtil.toastError("Invalid (null) Custom Component at position " + i);
            }
                ...
                if (componentVarName instanceof String) {
                    if (name.equals(componentVarName)) {
                        ...
                        if (componentImports instanceof String) {
                            ...
                            SketchProXUtil.toastError("Invalid imports entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                            break;
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Invalid variable name entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                }
            } else {
                SketchProXUtil.toastError("Invalid (null) Custom Component at position " + i);
            }
    ...
    public static String getPath() {
        return FileUtil.getExternalStorageDir().concat("/.SketchProX/data/system/component.json");
    }
    ...
    private static ArrayList<HashMap<String, Object>> readCustomComponents() {
        ...
        if (FileUtil.isExistFile(getPath())) {
            try {
                ...
                data = new ArrayList<>();
                SketchProXUtil.toastError("Couldn't read Custom Components file: " + e.getMessage());
            }
            if (data == null) {
                SketchProXUtil.toastError("Found invalid Custom Components file");
                data = new ArrayList<>();
            }
        } else {
            data = new ArrayList<>();
