...
public class BlocksHandler {
    ...
    public static void builtInBlocks(ArrayList<HashMap<String, Object>> arrayList) {
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.CropImage(this, %s, (int) %s);");
        hashMap.put("color", "#2AA4E2");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.isConnected(getApplicationContext())");
        hashMap.put("color", "#2AA4E2");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.CustomToast(getApplicationContext(), %s, %s, %s, %s, %s, SketchProXUtil.%s);");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.CustomToastWithIcon(getApplicationContext(), %s, %s, %s, %s, %s, SketchProXUtil.%s, R.drawable.%s);");
        hashMap.put("color", "#8A55D7");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.hideKeyboard(getApplicationContext());");
        hashMap.put("color", "#2AA4E2");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.showKeyboard(getApplicationContext());");
        hashMap.put("color", "#2AA4E2");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", "s");
        hashMap.put("code", "SketchProXUtil.copyFromInputStream(%s)");
        hashMap.put("color", "#A1887F");
        hashMap.put("palette", "-1");
        ...
        hashMap.put("type", " ");
        hashMap.put("code", "SketchProXUtil.sortListMap(%s, %s, %s, %s);");
        ...
        hashMap.put("code", "if (%1$s != null) {\r\n" +
                "%1$s.show(%2$s.this);\r\n" +
                "} else {\r\n" +
                "SketchProXUtil.showMessage(getApplicationContext(), \"Error: InterstitialAd %1$s hasn't been loaded yet!\");\r\n" +
                "}");
        hashMap.put("color", "#2aa4e2");
        hashMap.put("palette", "-1");
