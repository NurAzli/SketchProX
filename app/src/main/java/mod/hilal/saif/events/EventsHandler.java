...
public class EventsHandler {
    ...
    public static final String CUSTOM_EVENTS_FILE_PATH = FileUtil.getExternalStorageDir() + "/.SketchProX/data/system/events.json";
    public static final String CUSTOM_LISTENERE_FILE_PATH = FileUtil.getExternalStorageDir() + "/.SketchProX/data/system/listeners.json";
     ...
     * /Internal storage/.SketchProX/data/system/events.json and specifying an empty string for "var"
     */
                ...
                if (var instanceof String) {
                    if (var.equals("")) {
                        ...
                        if (name instanceof String) {
                            ...
                            SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Found invalid var data type in Custom Event #" + (i + 1));
                }
            } else {
                SketchProXUtil.toastError("Found invalid (null) Custom Event at position " + i);
            }
        }
                ...
                if (var instanceof String) {
                    if (gx.a((String) var)) {
                        ...
                        if (listener instanceof String) {
                            ...
                            SketchProXUtil.toastError("Found invalid listener data type in Custom Event #" + (i + 1));
                        }
                    }
                } else {
                    SketchProXUtil.toastError("Found invalid var data type in Custom Event #" + (i + 1));
                            ...
                            if (name.equals(eventName)) {
                                ...
                                if (icon instanceof String) {
                                    try {
                                        ...
                                        SketchProXUtil.toastError("Found invalid icon data type in Custom Event #" + (i + 1));
                        ...
                        if (eventName instanceof String) {
                            if (name.equals(eventName)) {
                                ...
                                if (description instanceof String) {
                                    ...
                                    SketchProXUtil.toastError("Found invalid description data type in Custom Event #" + (i + 1));
                                }
                            }
                        } else {
                            SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
                        ...
                        if (eventName instanceof String) {
                            if (name.equals(eventName)) {
                                ...
                                if (code instanceof String) {
                                    ...
                                    SketchProXUtil.toastError("Found invalid code data type in Custom Event #" + (i + 1));
                                }
                            }
                        } else {
                            SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
                        ...
                        if (eventName instanceof String) {
                            if (name.equals(eventName)) {
                                ...
                                if (parameters instanceof String) {
                                    ...
                                    SketchProXUtil.toastError("Found invalid parameters data type in Custom Event #" + (i + 1));
                                }
                            }
                        } else {
                            SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
                        ...
                        if (eventName instanceof String) {
                            if (event.equals(eventName)) {
                                ...
                                if (headerSpec instanceof String) {
                                    ...
                                    SketchProXUtil.toastError("Found invalid header spec data type in Custom Event #" + (i + 1));
                                }
                            }
                        } else {
                            SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
            ...
            if (eventName instanceof String) {
                if (name.equals(eventName)) {
                    ...
                    if (imports instanceof String) {
                        ...
                        SketchProXUtil.toastError("Found invalid import data type in Custom Event #" + (i + 1));
                    }
                }
            } else {
                SketchProXUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
