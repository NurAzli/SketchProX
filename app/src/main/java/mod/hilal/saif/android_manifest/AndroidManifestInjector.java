...
import com.SketchProX.remod.xml.XmlBuilder;
...
public class AndroidManifestInjector {
    ...
    public static File getPathAndroidManifestAttributeInjection(String sc_id) {
        return new File(Environment.getExternalStorageDirectory(),
                ".SketchProX" + File.separator + "data" + File.separator + sc_id + File.separator +
    ...
    private static ArrayList<HashMap<String, Object>> readAndroidManifestAttributeInjections(String sc_id) {
        ...
        parseAttributes:
        {
            ...
            SketchProXUtil.toastError("Failed to parse AndroidManifest attribute injections; Reason: " + errorMessage);
        }
        ...
        for (int i = 0; i < attributes.size(); i++) {
            ...
            if (name instanceof String) {
                ...
                if (value instanceof String) {
                    ...
                    SketchProXUtil.toastError("Invalid AndroidManifest attribute injection value in attribute #" + (i + 1));
                }
            } else {
                SketchProXUtil.toastError("Invalid AndroidManifest attribute injection name in attribute #" + (i + 1));
            }
        }
    }
