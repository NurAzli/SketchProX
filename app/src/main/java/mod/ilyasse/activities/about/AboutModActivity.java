...
public class AboutModActivity extends AppCompatActivity {
    private static final String ABOUT_TEAM_URL = "https://SketchProX-pro.github.io/SketchProX-Pro/aboutus.json";
    ...
    private class PagerAdapterImpl extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (position == 0) {
                ...
                majorChanges.setText("Major changes to SketchProX will appear here.");
