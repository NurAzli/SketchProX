            ...
            try {
                ...
                for (int i = 0; i < palettes.length(); i++) {
                    ...
                    try {
                        ...
                        SketchProXUtil.toastError("Couldn't parse color of Custom Block Palette #" + (i + 1));
                        color = 0xff8a55d7;
                    }
                ...
                SketchProXUtil.toastError("Error occurred while loading Custom Block Palette: " + e);
            }
        }
