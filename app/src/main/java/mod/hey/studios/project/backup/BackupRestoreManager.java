...
public class BackupRestoreManager {
    ...
    public void backup(String sc_id, String project_name) {
        ...
        checkboxContainer.setLayoutParams(new LinearLayout.LayoutParams(
                ...
                LinearLayout.LayoutParams.MATCH_PARENT));
        int dip = (int) SketchProXUtil.getDip(8);
    ...
    private static class BackupAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String _result) {
            ...
            if (bm.getOutFile() != null) {
                SketchProXUtil.toast("Successfully created backup to: " + bm.getOutFile().getAbsolutePath());
            } else {
                SketchProXUtil.toastError("Error: " + bm.error, Toast.LENGTH_LONG);
            }
        }
    }
    ...
    private static class RestoreAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String _result) {
            ...
            if (!bm.isRestoreSuccess() || error) {
                SketchProXUtil.toastError("Couldn't restore: " + bm.error, Toast.LENGTH_LONG);
            } else if (projectsFragment != null) {
                projectsFragment.refreshProjectsList();
                SketchProXUtil.toast("Restored successfully");
            } else {
                SketchProXUtil.toast("Restored successfully. Refresh to see the project", Toast.LENGTH_LONG);
            }
        }
    }
}