            ...
            case "Pretty print":
                if (getIntent().hasExtra("java")) {
                    ...
                    try {
                        ...
                        err = true;
                        SketchProXUtil.toastError("Your code contains incorrectly nested parentheses");
                    }
                    ...
                    if (format != null) {
                        ...
                        SketchProXUtil.toastError("Failed to format XML file", Toast.LENGTH_LONG);
                    }
                } else {
                    SketchProXUtil.toast("Only Java and XML files can be formatted");
                }
                break;

            case "Switch language":
                SketchProXUtil.toast("Currently not supported, sorry!");
                break;
