...
public class wq {
    ...
    public static final String A = "SketchProX" + File.separator + "localization" + File.separator + "strings_provided.xml";
    public static final String B = "SketchProX" + File.separator + "signed_apk";
    public static final String C = "SketchProX" + File.separator + "keystore";
    public static final String D = "SketchProX" + File.separator + "keystore" + File.separator + "release_key.jks";
    public static final String E = "SketchProX" + File.separator + "service_account";
    public static final String F = ".SketchProX" + File.separator + "upload";
    ...
    public static final String a = ".SketchProX" + File.separator + "libs";
    public static final String b = ".SketchProX" + File.separator + "mysc";
    public static final String c = ".SketchProX" + File.separator + "mysc" + File.separator + "list";
    public static final String d = ".SketchProX" + File.separator + "data";
    public static final String e = ".SketchProX" + File.separator + "bak";
    public static final String f = ".SketchProX" + File.separator + "temp" + File.separator + "images";
    public static final String g = ".SketchProX" + File.separator + "temp" + File.separator + "sounds";
    public static final String h = ".SketchProX" + File.separator + "temp" + File.separator + "fonts";
    public static final String i = ".SketchProX" + File.separator + "temp" + File.separator + "proj";
    public static final String j = ".SketchProX" + File.separator + "temp" + File.separator + "data";
    public static final String l = ".SketchProX" + File.separator + "resources";
    public static final String m = ".SketchProX" + File.separator + "resources" + File.separator + "icons";
    public static final String n = ".SketchProX" + File.separator + "resources" + File.separator + "images";
    public static final String o = ".SketchProX" + File.separator + "resources" + File.separator + "sounds";
    public static final String p = ".SketchProX" + File.separator + "resources" + File.separator + "fonts";
    public static final String r = ".SketchProX" + File.separator + "download" + File.separator + "apk";
    public static final String s = ".SketchProX" + File.separator + "download" + File.separator + "data";
    public static final String t = ".SketchProX" + File.separator + "tutorial" + File.separator + "images";
    public static final String u = ".SketchProX" + File.separator + "tutorial" + File.separator + "sounds";
    public static final String v = ".SketchProX" + File.separator + "tutorial" + File.separator + "fonts";
    public static final String w = ".SketchProX" + File.separator + "tutorial" + File.separator + "proj";
    public static final String x = ".SketchProX" + File.separator + "collection";
    public static final String y = "SketchProX" + File.separator + "localization";
    public static final String z = "SketchProX" + File.separator + "localization" + File.separator + "strings.xml";

    public static final String EXTRA_SYSTEM_DATA = ".SketchProX" + File.separator + "data" + File.separator + "system";
    ...
    public static String c() {
        return getAbsolutePathOf(".SketchProX" + File.separator + "download");
    }
    ...
    public static String q() {
        return getAbsolutePathOf(".SketchProX" + File.separator);
    }
    ...
    public static String s() {
        return getAbsolutePathOf("SketchProX");
    }
