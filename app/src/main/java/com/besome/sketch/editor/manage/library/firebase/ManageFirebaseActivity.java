...
public class ManageFirebaseActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private void openDoc() {
        try {
            ...
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            intent.setData(Uri.parse("https://SketchProX-pro.vercel.app/docs/components/Firebase/connect-to-firebase"));
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_console) {
            ...
            if (libSwitch.isChecked() || !firebaseLibraryBean.data.isEmpty()) {
                ...
                SketchProXUtil.toast("Configure Firebase settings first, either by importing google-services.json, " +
    ...
    private void parseDataFromGoogleServicesJson(String _data) {
        ...
        if (hasNullConfig) SketchProXUtil.toastError(notFoundLog.toString());
        configure();
    }
