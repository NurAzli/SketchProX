    ...
    public static String getComponentDocsUrlByTypeName(int type) {
        switch (type) {
            case COMPONENT_TYPE_INTENT:
                return "https://docs.SketchProX.io/docs/component-intent.html";

            case COMPONENT_TYPE_SHAREDPREF:
                return "https://docs.SketchProX.io/docs/component-shared-preference.html";

            case COMPONENT_TYPE_CALENDAR:
                return "https://docs.SketchProX.io/docs/component-calendar.html";

            case COMPONENT_TYPE_VIBRATOR:
                return "https://docs.SketchProX.io/docs/component-vibrator.html";

            case COMPONENT_TYPE_TIMERTASK:
                return "https://docs.SketchProX.io/docs/component-timer.html";

            case COMPONENT_TYPE_FIREBASE:
                return "https://docs.SketchProX.io/docs/component-firebase-database.html";

            case COMPONENT_TYPE_DIALOG:
                return "https://docs.SketchProX.io/docs/component-dialog.html";

            case COMPONENT_TYPE_MEDIAPLAYER:
                return "https://docs.SketchProX.io/docs/component-mediaplayer.html";

            case COMPONENT_TYPE_SOUNDPOOL:
                return "https://docs.SketchProX.io/docs/component-soundpool.html";

            case COMPONENT_TYPE_OBJECTANIMATOR:
                return "https://docs.SketchProX.io/docs/component-object-animator.html";

            case COMPONENT_TYPE_GYROSCOPE:
                return "https://docs.SketchProX.io/docs/component-gyroscope.html";

            case COMPONENT_TYPE_FIREBASE_AUTH:
                return "https://docs.SketchProX.io/docs/component-firebase-auth.html";

            case COMPONENT_TYPE_FIREBASE_CLOUD_MESSAGE:
                return "https://SketchProX-pro.vercel.app/docs/components/Firebase/cloud-messaging";

            case COMPONENT_TYPE_FIREBASE_DYNAMIC_LINKS:
                return "https://SketchProX-pro.vercel.app/docs/components/Firebase/dynamic-links";
            ...
            case COMPONENT_TYPE_FIREBASE_STORAGE:
                return "https://docs.SketchProX.io/docs/component-firebase-storage.html";

            case COMPONENT_TYPE_CAMERA:
                return "https://docs.SketchProX.io/docs/component-camera.html";

            case COMPONENT_TYPE_FILE_PICKER:
                return "https://docs.SketchProX.io/docs/component-filepicker.html";
