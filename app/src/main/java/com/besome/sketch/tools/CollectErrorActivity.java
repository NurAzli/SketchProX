...
public class CollectErrorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setMessage("An error occurred while running SketchProX. " +
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                String deviceInfo = "SketchProX " + info.versionName + " (" + info.versionCode + ")\n"
                ...
                new Thread(() -> {
                    ...
                    if (!listener.hasFailed()) {
                        runOnUiThread(() -> SketchProXUtil.toast("Sending crash logs…", Toast.LENGTH_LONG));
                    }
                }).start();
            });
        }
    ...
    private class WebhookListener implements RequestNetwork.RequestListener {
        ...
        public void onResponse(String tag, String response, HashMap<String, Object> responseHeaders) {
            SketchProXUtil.toast("Report sent!");
            finish();
        }
        ...
        public void onErrorResponse(String tag, String message) {
            failed = true;
            SketchProXUtil.toast("Couldn't report the error. You can try reporting the crash manually in our Discord server.", Toast.LENGTH_LONG);
        }
