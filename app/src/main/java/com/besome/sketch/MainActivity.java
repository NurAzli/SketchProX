...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
                ...
                new SingleCopyAsyncTask(data, this, new CallBackTask() {
                    ...
                    public void onCopyPostExecute(String path, boolean wasSuccessful, String reason) {
                        if (wasSuccessful) {
                            ...
                            SketchProXUtil.toastError("Failed to copy backup file to temporary location: " + reason, Toast.LENGTH_LONG);
                        }
                    }
                }).execute(data);
            }
            ...
            dialog.a("Just as a reminder; There have been many changes since v6.3.0 fix1, " +
                    ...
                    "You can view all changes whenever you want at the updated About SketchProX screen.");
    ...
    private void allFilesAccessCheck() {
        if (Build.VERSION.SDK_INT > 29) {
            ...
            if (!optOutFile.exists() && !granted) {
                ...
                dialog.a("Starting with Android 11, SketchProX needs a new permission to avoid " +
    ...
    private void tryLoadingCustomizedAppStrings() {
        ...
        try {
            ...
            SketchProXUtil.toastError(message + ": " + e.getMessage());
