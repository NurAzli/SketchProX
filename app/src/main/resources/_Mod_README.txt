...
This is an advanced SketchProX Mod that was re-modded from the SketchProX Revolution by Agus Jcoderz.
...
- Agus JCoderZ          (for the base mod, SketchProX Revolution)
- Auwal Emptyset        (for library downloading source)
- Ani1nonly
- Dava
- Ilyasse Salama        (for the new About SketchProX activity)
- Zarzo
...
DISCLAIMER: This mod was not meant for any harmful purposes, such as harming SketchProX; Quite the opposite actually: It was made to keep SketchProX alive.
Please use it on your own discretion and buy the SketchProX Premium subscription every month to support the original SketchProX team, even if you don't use it. 

We love SketchProX very much, and we are grateful to SketchProX's developers for making such an amazing app,
but unfortunately, we haven't received updates for a long time.
That's why we decided to keep SketchProX alive by making this mod, plus we don't demand any money - It's completely free :)
Also, starting with version 6.4.0 of the Mod, we've made some source code open source! You can check it out at https://github.com/SketchProX-Pro/SketchProX-Pro/,
and if you want to contribute, go fork it and open a pull request! We'd love to see new amazing features getting added to SketchProX :D

★ The change log can be found in the mod's Main Drawer.

**** FOR MODDERS ****

I made this part specifically for my fellow modders who want to contribute to SketchProX's development. Think of it as a little documentation :)

» DEX info

   classes.dex  -> Contains most of SketchProX's classes, including the packages a.a.a and com.besome.sketch.
   ...
   classes5.dex -> Contains all modders' classes: 
     ...
     and, SketchProX's most important classes that are modified for the Mod, including:
   ...
   classes6.dex -> This one is all about the compilation. Contains ProGuard, StringFog handler classes/activities, and:
       ...
       yq -> Organizes SketchProXjects' file paths.
